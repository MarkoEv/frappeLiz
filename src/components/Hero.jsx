...
function Hero() {
  ...
  const categories = {
    ...
    wraps: {
      icon: (
        <FaUtensils className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-[#7c4a31]" />
      ),
      label: "Wraps",
    },
    promociones: {
      icon: (
        <FaTags className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-[#7c4a31]" />
      ),
      label: "Promos",
    },
  };
